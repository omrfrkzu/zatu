// ================= Registration Page Controller (English) =====================
  ...
  class RegistrationPageController {
    ...
    generateSteps() {
      return [
        ...
        {
          id: 'location',
          title: 'Share your location information',
    ...
    renderBasicInfoStep() {
      ...
      const phoneGroup = this.createInputGroup({
        id: 'phone',
        label: 'Phone Number',
        helpText: 'For emergency notifications – recommended',
        type: 'tel',
      ...
      const consentGroup = this.createCheckboxGroup({
        id: 'dataConsent',
        label: 'I accept that my data will be processed.',
        required: true,
    ...
    renderBuildingStep() {
      ...
      const buildingAgeGroup = this.createSelectGroup({
        ...
        options: [
          ...
          { value: '11-20', text: '11-20 years' },
          { value: '21-30', text: '21-30 years' },
    ...
    renderSuccessStep() {
      ...
      title.textContent = 'Registration completed!';
      
      const text = document.createElement('p');
      text.className = 'registration-success-text';
      text.textContent = `Hello ${this.formData.fullName || 'User'}, you can now receive notifications specific to your area.`;
    ...
    updateNavigationButtons() {
      ...
      if (this.currentStep === this.totalSteps - 1) {
        ...
        this.elements.btnNext.innerHTML = '<span>Continue</span> <i class="bi bi-arrow-right"></i>';
      }
    }
    ...
    saveProgress() {
      ...
      localStorage.setItem('registration_page_progress_en', JSON.stringify(data));
    }

    loadProgress() {
      const saved = localStorage.getItem('registration_page_progress_en');
      if (saved) {
        try {
          ...
          if (data.currentStep !== undefined && data.currentStep < this.totalSteps && data.currentStep > 0) {
            showConfirmModal({
              ...
              if (confirmed) {
                ...
                localStorage.removeItem('registration_page_progress_en');
                this.formData = {};
                this.currentStep = 0;
                this.renderStep();
                this.updateProgress();
