...
// Ensures consistent navbar design across all pages
...
(function() {
  ...
  <header id="site-header" class="header-sticky">
    <div class="nav-shell">
      <!-- Left: Logo -->
      <div class="nav-left">
        <a class="navbar-brand" href="${texts.homeHref}"><img src="${basePath}images/logo/logo-main.png" class="logo" alt="${texts.logoAlt}"></a>
      </div>
      ...
      <div class="nav-right">
        ...
        <div class="mobile-actions">
          <button id="mode-toggle" class="btn-light-mode switch-button" aria-label="${texts.darkMode}"><i id="mode-icon" class="bi bi-moon-fill"></i></button>
