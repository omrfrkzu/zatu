...
(function() {
  ...
  const languages = {
    tr: {
      code: 'TR',
      name: 'Türkçe',
      flag: `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http:
      ...
      flagMobile: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http:
  ...
  function handleLanguageSelect(lang) {
    ...
    if (lang === 'en' && isTurkishPage) {
      ...
      let pathWithoutEn = currentPath.replace(/^\/en\
