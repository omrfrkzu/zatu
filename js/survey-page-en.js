// ================= Survey Page Controller (English) =====================
...
(function() {
  ...
  class SurveyPageController {
      ...
      return [
        {
          ...
          title: 'Which institution do you trust first in a disaster?',
          description: 'Which institution do you trust in a crisis?',
          options: [
            'AFAD',
            'Municipality',
            'Military',
        ...
        {
          id: 'feelingAlone',
          title: 'Do you feel alone in disaster preparedness?',
          description: 'How do you feel about preparedness?',
          options: [
            'Yes',
            'Sometimes',
            'No'
        ...
        },
        {
          ...
          title: 'Can institutions reach everyone?',
          description: 'Do you think official institutions can reach everyone?',
          options: [
            'Yes',
            'No',
            'Not sure'
        ...
        {
          id: 'powerSource',
          title: 'Where should the real power come from in a disaster?',
          description: 'What should be the source of power in a crisis?',
          options: [
            'Government',
            'Government + People',
            'Individual',
        ...
        {
          id: 'needNewSystem',
          title: 'Does Turkey need a new system?',
          description: 'Is the current system sufficient, or is a new approach needed?',
          options: [
            'Definitely yes',
            'Maybe',
            'Already sufficient',
    ...
    updateNavigationButtons() {
      ...
      if (this.currentQuestion === this.totalQuestions - 1) {
        this.elements.btnNext.innerHTML = '<span>Complete</span> <i class="bi bi-check-circle"></i>';
      } else {
    ...
    renderCompletion() {
      // Update title
      this.elements.questionTitle.textContent = 'Thank you!';
      ...
      title.textContent = 'Your opinions have been recorded';
      
      const text = document.createElement('p');
      text.className = 'survey-success-text';
      text.textContent = 'The opinions you shared will help us improve our network. Thank you for your contribution!';
      ...
      homeBtn.innerHTML = '<span>Return to Homepage</span> <i class="bi bi-arrow-right"></i>';
    ...
    saveProgress() {
      ...
      localStorage.setItem('survey_page_progress_en', JSON.stringify(data));
    }

    loadProgress() {
      const saved = localStorage.getItem('survey_page_progress_en');
      if (saved) {
        try {
          ...
          if (data.currentQuestion !== undefined && data.currentQuestion < this.totalQuestions) {
            showConfirmModal({
              ...
              if (confirmed) {
                ...
                localStorage.removeItem('survey_page_progress_en');
                this.answers = {};
                this.currentQuestion = 0;
                this.renderQuestion();
                this.updateProgress();
